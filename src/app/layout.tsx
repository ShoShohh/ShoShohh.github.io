...
<nav className="w-full p-4 text-right bg-[#FFFCF8] border-b border-neutral-200 dark:border-neutral-800">
  {/* 英語 (ルート) */}
  <Link
    href="/"
    className="mr-4 text-sm text-blue-600 underline hover:text-blue-800"
  >
    English
  </Link>
